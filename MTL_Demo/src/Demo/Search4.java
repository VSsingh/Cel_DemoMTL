...
System.out.println("Searched keyword under ribbon didplay screen : "+DisplayRibbon.getText());
      driver.findElement(By.id(Repository_Archive.RibbonDecidebutton_id)).click();     // click on myribbon decide button to register
      driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
      driver.findElement(By.id(Repository_Archive.HamburgerMenu_id)).click();
     try{
 		 Thread.sleep(3000);
 	 }catch(Exception e){}
 	 
 	 
    WebElement categoryribbonverify = driver.findElement(By.xpath(Repository_Archive.CategoryRibbonSearched_xpath));
     System.out.println("Searched register ribbon under category ribbon list is : "+categoryribbonverify.getText()); 
