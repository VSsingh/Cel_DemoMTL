//Prerequisite all ribbons must be deleted first and make sure none of the ribbons are available under ribbon list
...
public class MyRibbonDeletion_Demo {
	...
	@Test(priority=0)
	public void ribbon_Register1() throws TimeoutException,InterruptedException
	{
